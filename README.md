...
I wrote the code in C, and to simplify the execution process, I created a PBS script that allows me to run all the necessary instructions in a single step. 
<br>
